...
| `docs/HANDOFFS/DOMESDAY/DOMESDAY_1_HANDOFF.md` | KEEP — not a citation | `read \`LANTERN_CENSUS.md\` §L2 in full` — a section reference in another document. Same false-positive class. |

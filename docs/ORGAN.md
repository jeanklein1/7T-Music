...
by law — fog, ribbon, the cube light, and the ground's four (the strike
ring, the relief, and the keyboard's stain and ink) — with the aura's
`intent` as the one literal switch. The strip is built and it

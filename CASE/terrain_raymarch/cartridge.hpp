...
/**
 * TERRAIN RAYMARCH - Render Cartridge
 * ====================================
 * 
 * Raymarching visualization of terrain and pawn.
 * 
 * SAME INTERFACE, DIFFERENT RENDERING
 * ------------------------------------
 * 
 * This cartridge implements the same RenderCartridge interface as terrain_pawn.
 * Same inputs, same buffers, same dynamics. Only the rendering differs:
 * 
 * - terrain_pawn: rasterizes meshes via vertex pulling
 * - terrain_raymarch: raymarches SDFs in fragment shader
 * 
 * Swap one line in main.cpp to switch rendering methods.
 */

#include "render/render_cartridge.hpp"
#include "core/input_event.hpp"
#include "cartridges/terrain_raymarch/state.hpp"
#include "cartridges/terrain_raymarch/renderer.hpp"
#include <cmath>
...
public:
    ...
    void render(wgpu::CommandEncoder& encoder,
        ...
        // Render pass (single fullscreen draw)
        {
            ...
            // No depth attachment - raymarching handles occlusion internally

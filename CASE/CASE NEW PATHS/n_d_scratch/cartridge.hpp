...
/**
 * N-DIMENSIONAL_2 CARTRIDGE — Render Cartridge
 * =============================================
 * 
 * Compute-first architecture with multiple stimulus sources (pawn + sphere).
 * 
 * EXECUTION ORDER (mirrors world.wgsl §6 COMPOSE):
 *   1. Upload signal (CPU → GPU)
 *   2. Upload config (CPU → GPU)
 *   3. Compute: update_world        [0D] — includes sphere orbit
 *   4. Compute: update_height_field [2D]
 *   5. Compute: update_tiles        [2D] — pawn + sphere stimulus compound
 *   6. Render:  fullscreen raymarch — includes sphere rendering
 * 
 * DESIGN MODE:
...
#include "cartridges/n_dimensional_2/state.hpp"
#include "cartridges/n_dimensional_2/renderer.hpp"
#include <cmath>
#include <iostream>
...
public:
     ...
     * Good for testing pawn influence in isolation.
     */
     ...
     * Good for testing sphere influence in isolation.
     */

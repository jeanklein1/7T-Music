...
/**
 * N-DIMENSIONAL_2 CARTRIDGE — Renderer
 * =====================================
 * 
 * Pipeline management for compute-first architecture with sphere entity.
 * 
 * PIPELINES:
 * ┌────────────────────┬─────────────┬──────────────────────────────┐
 ...
 * │ updateTiles        │ 2D (8²)     │ trajectory_field, tile_state │
...
private:
    ...
    bool loadShader() {
        ...
        std::array<const char*, 6> paths = {
            "src/cartridges/n_dimensional_2/world.wgsl",
            "cartridges/n_dimensional_2/world.wgsl",
            "../src/cartridges/n_dimensional_2/world.wgsl",
            "n_dimensional_2/world.wgsl",
            "world.wgsl",
            "shaders/world.wgsl"
        };
        ...
        desc.label = "world.wgsl (N-Dimensional_2 Cartridge)";

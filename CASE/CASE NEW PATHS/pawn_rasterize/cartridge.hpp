...
/**
 * PAWN RASTERIZE — Cartridge
 * ===========================
 *
 * Rasterized pawn viewer with hot reload.
 * 
 * CONTROLS:
 *   Mouse drag     Orbit camera
 *   Right drag     Pan
 *   Scroll         Zoom
 *   Backspace      Return to gallery (if in incubator)
 *
 * HOT RELOAD:
 *   Edit world.wgsl → file watcher triggers reload_shaders()
 *   Lighting, colors, effects update instantly.
 *   Mesh geometry requires rebuild (it's baked from C++).
 *
...
#include "cartridges/pawn_rasterize/state.hpp"
#include "cartridges/pawn_rasterize/renderer.hpp"
#include <cmath>
#include <iostream>

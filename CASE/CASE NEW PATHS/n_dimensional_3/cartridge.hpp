...
/**
 * N-DIMENSIONAL_3 CARTRIDGE — Render Cartridge
 * =============================================
 * 
 ...
 *   4. Compute: update_height_field [2D] — terrain elevation
 *   5. Compute: update_cells        [2D] — evolve color trajectories
 *   6. Compute: update_tiles        [2D] — copy cell.value to texture
 *   7. Render:  fullscreen raymarch — includes sphere rendering
 * 
 * CORE PRINCIPLE:
...
#include "cartridges/n_dimensional_3/state.hpp"
#include "cartridges/n_dimensional_3/renderer.hpp"
#include <cmath>
#include <iostream>
...
public:
    ...
    //   3. Compute: update_cells        [2D] — trajectory evolution
    //   4. Compute: update_tiles        [2D] — copy to texture
    ...
    void render(wgpu::CommandEncoder& encoder,
        ...
        // ─── COMPUTE PHASE ──────────────────────────────────────────────────
        {
            ...
            // Pass 3: Update cells (2D) — trajectory evolution
            ...
            // Pass 4: Update tiles (2D) — copy cell.value to texture

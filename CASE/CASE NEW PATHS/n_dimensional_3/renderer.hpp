...
/**
 * N-DIMENSIONAL_3 CARTRIDGE — Renderer
 * =====================================
 * 
 ...
 *   2. update_height_field — terrain elevation
 *   3. update_cells        — evolve color trajectories
 *   4. update_tiles        — copy cell.value to texture
...
public:
    ...
    //   3. update_cells        — 2D cell trajectories (reads entities)
    //   4. update_tiles        — 2D tile texture (reads cells)
...
private:
    ...
    bool loadShader() {
        ...
        std::array<const char*, 6> paths = {
            "src/cartridges/n_dimensional_3/world.wgsl",
            "cartridges/n_dimensional_3/world.wgsl",
            "../src/cartridges/n_dimensional_3/world.wgsl",
            "n_dimensional_3/world.wgsl",
            "world.wgsl",
            "shaders/world.wgsl"
        };
        ...
        desc.label = "world.wgsl (N-Dimensional_3 Cartridge)";
    ...
    bool createRenderPipeline() {
        ...
        desc.label = "World Raymarch (N-Dimensional_3 Cartridge)";
        desc.layout = layout;

// ═══════════════════════════════════════════════════════════════════════════════
// N-DIMENSIONAL CARTRIDGE — GPU Scroll
// ═══════════════════════════════════════════════════════════════════════════════
//
// A pawn traversing a musically-reactive wave terrain with spatial memory.
//
// ┌─────────────────────────────────────────────────────────────────────────────┐
// │ MANIFEST                                                                    │
// ├─────────────────────────────────────────────────────────────────────────────┤
...
// │            • 1 entity→substrate  (pawn proximity → field color)   [NEW]     │
// └─────────────────────────────────────────────────────────────────────────────┘
//
// COUPLING GRAPH:
//
...
//   §3  FIELDS ............................ line 192
//   §4  ENTITIES .......................... line 308
//   §5  COUPLINGS ......................... line 403
//   §6  COMPOSE ........................... line 541
//   §7  RENDER ............................ line 723
//   §8  BINDINGS .......................... line 882
//   §9  ENTRY POINTS ...................... line 937
//
// ═══════════════════════════════════════════════════════════════════════════════
...
fn compose_update_tiles(texel: vec2<u32>) {
    ...
    // ═══════════════════════════════════════════════════════════════════════
    // STIMULUS: Compute pawn proximity influence
    // ═══════════════════════════════════════════════════════════════════════
    ...
    if (coupling_active(COUPLING_PAWN_TO_FIELD_COLOR)) {
        stimulus = field_pawn_stimulus(tile_world, pawn_xz);
    }
...
@group(0) @binding(6) var<storage, read_write> trajectory_field: array<Trajectory, 4096>;

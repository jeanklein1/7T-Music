...
/**
 * N-DIMENSIONAL CARTRIDGE — GPU State Management
 * ===============================================
 * 
 * DIMENSIONALITY:
...
namespace Coupling {
    ...
    constexpr uint32_t FIELD    = PAWN_TO_FIELD_COLOR;
}
...
private:
    ...
    bool createBuffers() {
        ...
        return signalBuffer_ && configBuffer_ && groundBuffer_ && 
               pawnBuffer_ && cameraBuffer_ && trajectoriesBuffer_ &&
               trajectoryFieldBuffer_;
    }
    ...
    bool createBindGroups() {
        ...
        // Compute layout: bindings 0-6 (signal, config, ground, pawn, camera, trajectories, trajectory_field)
        {

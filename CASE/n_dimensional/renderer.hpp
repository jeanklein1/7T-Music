...
/**
 * N-DIMENSIONAL CARTRIDGE — Renderer
 * ===================================
 * 
...
private:
    ...
    bool loadShader() {
        ...
        std::array<const char*, 6> paths = {
            "src/cartridges/n_dimensional/world.wgsl",
            "cartridges/n_dimensional/world.wgsl",
            "../src/cartridges/n_dimensional/world.wgsl",
            "n_dimensional/world.wgsl",
            "world.wgsl",
            "shaders/world.wgsl"
        };
        ...
        desc.label = "world.wgsl (N-Dimensional Cartridge)";

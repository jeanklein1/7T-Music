...
/**
 * DESIGN CARTRIDGE — Render Cartridge
 * =====================================
 *
 * Compute-first architecture with Design Mode support.
 *
...
#include "cartridges/design_cartridge/renderer.hpp"
#include <cmath>
#include <iostream>
...
namespace t7 {
    namespace design_cartridge {
        ...
        public:
             ...
             * Freezes coupling wiring at current state (does not reset to idle).
             * To see pure idle state, call this immediately after init.
             */

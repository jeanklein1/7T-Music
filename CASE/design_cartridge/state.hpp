...
/**
 * DESIGN CARTRIDGE — GPU State Management
 * ========================================
 * 
 * DIMENSIONALITY:
 *   0D — Buffers (scalar/struct): ground, pawn, camera, config
 *   1D — Buffers (array): trajectories
...
private:
    ...
    bool createBindGroups() {
        ...
        // Compute layout: bindings 0-5 (signal, config, ground, pawn, camera, trajectories)
        {

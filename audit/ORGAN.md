...
reader — the class of defect this witness exists to catch.
  ...
  MOOD_TABLE           definition=1 seed=6 static_assert=26 constexpr=4 comment=29 
        constexpr derivation  src/cartridges/the_board/bodies/gallery.hpp:416  MOOD_TABLE[MOOD_INDOOR_FLAT].shape.finite_radius_max
        constexpr derivation  src/cartridges/the_board/bodies/gallery.hpp:417  > MOOD_TABLE[MOOD_INDOOR_VAULT].shape.finite_radius_max
        constexpr derivation  src/cartridges/the_board/bodies/gallery.hpp:418  ? MOOD_TABLE[MOOD_INDOOR_FLAT].shape.finite_radius_max
        constexpr derivation  src/cartridges/the_board/bodies/gallery.hpp:419  : MOOD_TABLE[MOOD_INDOOR_VAULT].shape.finite_radius_max;

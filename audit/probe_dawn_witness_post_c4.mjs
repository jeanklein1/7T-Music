...
// against the BATCH tree: layouts re-parsed into audit/cc6_output_post_c4.json;
...
// edit landed coherently. Writes audit/probe_results_post_c4.json.
//
...
const cc6 = JSON.parse(readFileSync('audit/cc6_output_post_c4.json', 'utf8'));
...
writeFileSync('audit/probe_results_post_c4.json', JSON.stringify(result, null, 2));
const flat = [];

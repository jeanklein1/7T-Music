...
// against the BATCH tree: layouts re-parsed into audit/cc6_output_post_gc1.json,
...
// coherently. Writes audit/probe_results_post_gc1.json.
//
...
const cc6 = JSON.parse(readFileSync('audit/cc6_output_post_gc1.json', 'utf8'));
...
writeFileSync('audit/probe_results_post_gc1.json', JSON.stringify(result, null, 2));
const flat = [];

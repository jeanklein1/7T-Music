...
// ─── console_10_limit.hpp ────────────────────────────────────────
//
// The 7T runtime infrastructure (10-limit variant): the platform shell
// for the visualizer. Owns the window, GPU device, surface, depth
// buffer, input collection, and frame timing. Does NOT own cartridges,

...
// THE_CHORD CARTRIDGE -- Renderer (Rasterized)
// ==================================================
//
...
//
// RENDER PIPELINES:
//   patch_terrain, zone_extrusion, pawn, sphere, monolith,
//   ribbon, shell, gallery_frame + shadow variants for each
//
    ...
    namespace the_chord {
        ...
        private:
            ...
            bool loadShader() {
                ...
                desc.label = "world.wgsl (The_Chord Cartridge)";

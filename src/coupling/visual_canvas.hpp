...
namespace t7 {
    ...
    inline constexpr ParamSlot PARAM_LAYOUT[] = {
        ...
        // ── (slots 51–52 stood here: ground.energy / ground.density,
        // the ground's voice — GROUND_VOICE_0 → RELIEF_1, excised by
        // ruling.) The SOURCE-shaped pipes in this bank are now
        // ground.strike and ground.relief below; the seam applies each
        // law, the canvas decodes nothing for them.
    ...
    public:
        ...
        void tick(const AnalysisSignal& signal) {
            ...
            // The ground's-voice writes stood here (RELIEF_1 tombstone in
            // cartridge.hpp's seam says why).
